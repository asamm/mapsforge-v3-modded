...
public class JobParameters implements Serializable {
	 ...
	 */
	public final RenderThemeDefinition jobTheme;
	 ...
	 *            the text scale factor which should applied to the render theme.
	 */
	public JobParameters(RenderThemeDefinition jobTheme, float textScale) {
	...
	public boolean equals(Object obj) {
        ...
        return Float.floatToIntBits(this.textScale) == Float.floatToIntBits(other.textScale);
    }
