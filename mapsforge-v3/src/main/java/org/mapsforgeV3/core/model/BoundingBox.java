...
public class BoundingBox implements Serializable {
	...
	public static BoundingBox fromString(String boundingBoxString) {
		double[] coordinates = CoordinatesUtils.parseCoordinateString(boundingBoxString, 4);
		int minLat = CoordinatesUtils.degreesToMicrodegrees(coordinates[0]);
		int minLon = CoordinatesUtils.degreesToMicrodegrees(coordinates[1]);
		int maxLat = CoordinatesUtils.degreesToMicrodegrees(coordinates[2]);
		int maxLon = CoordinatesUtils.degreesToMicrodegrees(coordinates[3]);
	...
	private static void validateCoordinates(int minLatitudeE6, int minLongitudeE6, int maxLatitudeE6, int maxLongitudeE6) {
		CoordinatesUtils.validateLatitude(CoordinatesUtils.microdegreesToDegrees(minLatitudeE6));
		CoordinatesUtils.validateLongitude(CoordinatesUtils.microdegreesToDegrees(minLongitudeE6));
		CoordinatesUtils.validateLatitude(CoordinatesUtils.microdegreesToDegrees(maxLatitudeE6));
		CoordinatesUtils.validateLongitude(CoordinatesUtils.microdegreesToDegrees(maxLongitudeE6));
	...
	public double getMaxLatitude() {
		return CoordinatesUtils.microdegreesToDegrees(this.maxLatitudeE6);
	}
	...
	public double getMaxLongitude() {
		return CoordinatesUtils.microdegreesToDegrees(this.maxLongitudeE6);
	}
	...
	public double getMinLatitude() {
		return CoordinatesUtils.microdegreesToDegrees(this.minLatitudeE6);
	}
	...
	public double getMinLongitude() {
		return CoordinatesUtils.microdegreesToDegrees(this.minLongitudeE6);
	}
