...
public class GeoPoint implements Comparable<GeoPoint>, Serializable {
	...
	public static GeoPoint fromString(String geoPointString) {
		double[] coordinates = CoordinatesUtils.parseCoordinateString(geoPointString, 2);
	...
	private static void validateCoordinates(int latitudeE6, int longitudeE6) {
		CoordinatesUtils.validateLatitude(CoordinatesUtils.microdegreesToDegrees(latitudeE6));
		CoordinatesUtils.validateLongitude(CoordinatesUtils.microdegreesToDegrees(longitudeE6));
	}
	...
	public GeoPoint(double latitude, double longitude) {
		this(CoordinatesUtils.degreesToMicrodegrees(latitude), CoordinatesUtils.degreesToMicrodegrees(longitude));
	}
	...
	public double getLatitude() {
		return CoordinatesUtils.microdegreesToDegrees(this.latitudeE6);
	}
	...
	public double getLongitude() {
		return CoordinatesUtils.microdegreesToDegrees(this.longitudeE6);
	}
	...
	public String toString() {
        return "GeoPoint [latitudeE6=" + this.latitudeE6 + ", " +
                "longitudeE6=" + this.longitudeE6 + "]";
	}
